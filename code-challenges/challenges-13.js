...
const objectCounter = (obj) => {
    ...
    const num1 = obj.reduce((counter, x) => x.voter_Name != null ? counter += 1 : counter, 0 ); 
    return num1 ;
}
...
const statistics = (obj) => {
    // write your code here
    const res1 = obj.reduce((acc1, order1) => {
        return { ...acc1, [order1.votes_To]: (acc1[order1.votes_To]||0)+ 1 };
      }, {});
      return res1;
}
